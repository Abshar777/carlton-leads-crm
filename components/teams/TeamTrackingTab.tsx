...
const STATUS_TO_COLS = [
  ...
  { key: "status_to_notinterested"  as const, label: "→ Not Int.",     color: "bg-orange-500/20 text-orange-500"   },
  { key: "status_to_closed"         as const, label: "→ Closed",       color: "bg-green-500/20 text-green-500"     },
  { key: "status_to_invalid"        as const, label: "→ Invalid",      color: "bg-red-500/20 text-red-500"         },
