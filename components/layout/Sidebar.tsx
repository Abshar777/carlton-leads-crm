...
export const navItems = [
  ...
  { href: "/ai-agent", label: "AI Agent", icon: BrainCircuit, permModule: "ai-agent" },
  { href: "/whatsapp", label: "WhatsApp", icon: MessageCircle, permModule: "whatsapp" },
    ...
    <div className="flex h-16 items-center gap-3 border-b border-sidebar-border/10 px-4 shrink-0">
      ...
      <AnimatePresence>
        {!collapsed && (
          ...
          >
            <p className="text-sm font-bold text-sidebar-foreground whitespace-nowrap">Carlton CRM</p>
  ...
  return (
    <TooltipProvider delayDuration={0}>
      <motion.aside
        ...
        className="relative hidden md:flex h-full flex-col bg-sidebar overflow-hidden rounded-r-3xl shadow-[4px_0_32px_rgba(0,0,0,0.45)]"
      >
